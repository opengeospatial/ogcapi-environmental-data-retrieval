= OGC API - Environmental Data Retrieval Standard - Example profile based on NWP Pressure Level data
...
:local-cache-only:
:data-uri-image:
:pdf-uri: ./NWP_Pressure_Level_Profile.pdf
:xml-uri: ./NWP_Pressure_Level_Profile.xml
:doc-uri: ./NWP_Pressure_Level_Profile.doc
:edition: 1.0
