...
include::../requirements/REQ_modspec.adoc[]

Implementations of the Profile are conformant with OGC API-EDR Part 1: Core

include::../requirements/REQ_EDR-conformant.adoc[]
...
include::../requirements/REQ_data-query-radius.adoc[]
...
include::../requirements/REQ_data-query-locations.adoc[]
