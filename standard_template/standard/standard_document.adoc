...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/{doc-type}/{standard}/{0.1}
|Internal reference number of this OGC(R) document:    19-086r0
|Version: 0.1
|Category: OGC(R) Standard
|Editor:   Chris Little, Dave Blodgett
|===
