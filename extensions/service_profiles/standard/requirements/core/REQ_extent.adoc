...
statement:: A Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> _SHALL_ define a requirement defining a `bbox` which specifies the minimum spatial bounds that _SHALL_ be supported
...
statement:: If a Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> supports Extents with spatial dimensions, then:
part:: The Service Profile _SHALL_ specify the rules for the spatial Coordinate Reference System (CRS).
...
statement:: If a Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> supports Extents with a temporal dimension, then:
part:: The Service Profile _SHALL_ specify the rules for expressing the Temporal Reference System (TRS).
part:: Those rules _SHALL_ be specified using either:
...
statement:: If a Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> supports Extents with a vertical dimension, then:
part:: The Service Profile _SHALL_ specify the rules for expressing the Vertical Reference System (VRS).
part:: Those rules _SHALL_ be specified using either:
...
statement:: If a Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> supports Extents with a custom dimension, then:
part:: The Service Profile _SHALL_ specify the rules for expressing the custom dimension.
part:: Those rules _SHALL_ be specified using either:
