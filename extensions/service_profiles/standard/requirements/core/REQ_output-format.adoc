...
====
[%metadata]
identifier:: /rec/core/output-format-schema
statement:: Data schemas MAY be restrictive as needed to promote interoperability, while still accomodating all valid responses.
