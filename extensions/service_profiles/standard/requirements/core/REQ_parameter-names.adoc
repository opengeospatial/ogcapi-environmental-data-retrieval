...
statement:: If a Service Profile of the <<ogc-edr,OGC API - Environmental Data Retrieval Standard>> _restricts_ the allowed values and definitions of `parameter_names`, then,
