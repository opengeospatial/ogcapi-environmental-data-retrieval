...
A named set of requirements and constraints that specialize one or more base standards for a specific community or domain of use.

[.source]
<<iso19106,ISO 19106:2004 Geographic information - Profiles>>

[[service-profile-definition]]
=== Service Profile

A Profile of the OGC API – Environmental Data Retrieval (EDR) Part 1: Core Standard that defines a constrained and well-specified set of requirements for a specific domain or community of use.
