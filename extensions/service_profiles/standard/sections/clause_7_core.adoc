...
Profiles of the <<ogc-edr,OGC API – Environmental Data Retrieval Standard>> are expected to provide a richer description of the API. The requirements below define additional content rules that Profiles can mandate.
