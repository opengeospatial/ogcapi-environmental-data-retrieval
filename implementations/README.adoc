...
This page lists software packages that implement approved or draft OGC API-EDR standards. Draft standards are only added once they have a tagged version. Currently the following parts are covered:

* https://docs.ogc.org/is/19-086r4/19-086r4.html[OGC API - Environmental Data Retrieval Standard V1.0]
* https://docs.ogc.org/is/19-086r5/19-086r5.html[OGC API - Environmental Data Retrieval Standard V1.0.1 Corrigendum]
* https://docs.ogc.org/is/19-086r6/19-086r6.html[OGC API - Environmental Data Retrieval Standard V1.1]
* https://docs.ogc.org/DRAFTS/19-086r7.html[OGC API - Environmental Data Retrieval Standard V1.2]
* https://docs.ogc.org/is/23-057r1/23-057r1.html[OGC API - Environmental Data Retrieval Standard Part 2: Publish-Subscibe Workflow V1.0]
...
| link:servers/murithigeo-ogc-edr.md[Demo Implementation in TypeScript]
