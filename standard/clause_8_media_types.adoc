...
=== Media Types
A description of the MIME-types is mandatory for any OGC standard which involves data encodings. The list of suitable MIME-types for the API-EDR standard in provided in <<api-records-mime-types>>.

[#api-edr-mime-types,reftext='{table-caption} {counter:table-num}']
.API-EDR MIME Types
[width="90%",cols="2,4"]
|====
^|*Encoding* ^|*MIME Type*
