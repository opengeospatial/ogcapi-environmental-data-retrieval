...
:committee: technical
:draft: 3.0
:external-id: http://www.opengis.net/doc/IS/ogcapi-edr-1/1.1
:docnumber: 19-086r6
...
include::sections/clause_10_pubsub.adoc[]

include::sections/clause_10_pubsub_message_payload.adoc[]
...
include::sections/annex_pubsub.adoc[]

include::sections/annex_pubsub_message_payload.adoc[]
