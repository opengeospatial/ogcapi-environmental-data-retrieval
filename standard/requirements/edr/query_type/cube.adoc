...
#If a client request has a *bbox* value which includes a height values and defines a *z* query parameter the *z* query parameter will be the definition of the requested height value#
