...
|==========================
|Field Name|Type|Required|Description
|**interval**  | ISO 8601 Date Array|**Yes**| An array of ISO 8601 datestrings, each member of the array can either be a single time, an ISO8601 time interval or an ISO8601 time duration (see https://en.wikipedia.org/wiki/ISO_8601)
