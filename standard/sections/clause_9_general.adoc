...
Apply <<req_core_crs84,Requirement /req/core/crs84>> for CRS84 support.
...
The <<OGC19-072,OGC API - Common - Part 1: Core>> specification does not mandate any specific security controls. However, it was constructed so that security controls can be added without impacting conformance.
