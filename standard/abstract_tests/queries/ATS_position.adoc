...
^|Requirement |<<_req_queries_position,/req/queries/position>>
^|Test Method |. Check coords query parameter is a valid Well Known Text Point or MultiPoint value
. Validate that a document was returned with a status code 400.
|===
