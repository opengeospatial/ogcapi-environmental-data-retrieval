...
|===
^|*Abstract Test {ats-id}* |*/conf/trajectory*
^|Test Purpose |Validate that an error is returned by a `Trajectory` query when the coords query parameter does not contain a valid LILINESTRING or MULTILINESTRING Well Known Text value.
^|Requirement |<<_req_edr_rc-trajectory,/req/edr/rc-trajectory>>
...
|===
^|*Abstract Test {ats-id}* |*/conf/trajectory*
^|Test Purpose |Validate that an error is returned by a `Trajectory` query when the coords query parameter does not contain a valid LLINESTRINGM or MULTILINESTRINGM Well Known Text value.
^|Requirement |<<_req_edr_rc-trajectory,/req/edr/rc-trajectory>>
