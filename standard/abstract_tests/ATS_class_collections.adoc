...
|===
2+|*Conformance Class*
2+|http://www.opengis.net/spec/ogcapi-edr-1/1.1/conf/collections
|Target type |Web API
|Requirements Class |<<rc_collections,http://www.opengis.net/spec/ogcapi-edr-1/1.1/req/collections>>
