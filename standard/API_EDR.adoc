:Title: OGC API - Environmental Data Retrieval - Part 1: Core
:titletext: OGC API - Environmental Data Retrieval - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document: 20-000
|Version: 0.0.1
...
include::clause_11_JSON.adoc[]

include::clause_12_XML.adoc[]

include::clause_13_oas.adoc[]
