...
Servers conforming to this requirements class define their API by an link:https://spec.openapis.org/oas/v3.0.4#openapi-document[OpenAPI 3.0 Document].
...
Servers conforming to this requirements class define their API by an link:https://spec.openapis.org/oas/v3.1.1#openapi-document[OpenAPI 3.1 Document].
