...
Servers conforming to OpenAPI Specification 3.0 requirements class provide their API definition by an link:https://spec.openapis.org/oas/v3.0.4#openapi-document[OpenAPI 3.0 Document].
