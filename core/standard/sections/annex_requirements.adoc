...
include::../requirements/edr/REQ_rc-locations-variables.adoc[]
...
==== Common Requirements for Data Queries

include::../requirements/edr/REQ_rc-core-query-parameters.adoc[]
