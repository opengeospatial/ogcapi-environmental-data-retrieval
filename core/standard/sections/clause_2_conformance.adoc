...
* <<rc_oas,OpenAPI Specification>>, one Requirements Class
* <rc_oas30-section,Chapter 9>> and <<rc_oas30, Annex A>> in more detail.
* <<rc_oas31-section,Chapter 9>> and <<rc_oas31, Annex A>> in more detail.
