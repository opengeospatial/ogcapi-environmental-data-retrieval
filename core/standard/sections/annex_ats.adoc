...
implementations of the EDR API Standard. An ATS provides a basis for developing an Executable Test Suite to verify that the implementation being tested conforms to all the relevant functional specifications.

The abstract test cases (assertions) are organized into test groups that correspond to distinct conformance test classes defined in the EDR API Standard.
