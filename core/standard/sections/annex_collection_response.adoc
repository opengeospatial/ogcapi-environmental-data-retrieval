...
|**values**  | <<col-spatial_values, spatial values>>|**No**| Describes the spatial resolution of the data
...
|==========================
|Field Name|Type|Required|Description
|**link**  | <<col-links,Link>> object|**Yes**| Link for the query.
|==========================
...
^1^ Either one of label or symbol or both attributes SHALL be present in a unit object
