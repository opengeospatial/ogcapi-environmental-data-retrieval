...
|<<rc_collection-section,Collections>>| http://www.opengis.net/spec/ogcapi-common-2/1.0/req/collections
|<<requirements-class-openapi_3_0-clause,OpenAPI 3.0>>| http://www.opengis.net/spec/ogcapi-common-1/1.0/req/oas30
|<<media-types-section,GeoJSON>>| http://www.opengis.net/spec/ogcapi-common-1/1.0/req/json
|<<media-types-section,CoverageJSON>>| http://www.opengis.net/spec/ogcapi-common-1/1.0/req/json
|<<media-types-section,HTML>>| http://www.opengis.net/spec/ogcapi-common-1/1.0/req/html
|====
