...
There are links to the responses of the <<collection-definition,collections>> http://www.opengis.net/def/rel/iana/1.0/self[link relation type "self"]. 

Representations of these resource in other formats are referenced using http://www.opengis.net/def/rel/iana/1.0/alternate[link relation type "alternate"].

The data queries that are supported by each <<collection-definition,collection>> are referenced using http://www.opengis.net/def/rel/ogc/1.0/data[link relation type "data"].
