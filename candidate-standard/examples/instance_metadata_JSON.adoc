...
There is a link to the instance response itself http://www.opengis.net/def/rel/iana/1.0/self[link relation type "self"]. 

Representations of this resource in other formats are referenced using Representations of these resource in other formats are referenced using http://www.opengis.net/def/rel/iana/1.0/alternate[link relation type "alternate"].

The data queries that are supported by each instance are referenced using http://www.opengis.net/def/rel/ogc/1.0/data[link relation type "data"].

There are also links to the license information for the observation and forecast data http://www.opengis.net/def/rel/iana/1.0/license[link relation type "license"] and also the terms and conditions of service https://www.iana.org/go/rfc6903[link relation type "restrictions"].
