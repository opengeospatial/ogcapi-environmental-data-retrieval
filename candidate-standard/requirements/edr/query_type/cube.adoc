...
Only data that has a geometry that intersects the <<area-definition,area>> defined by the cube
are selected. 
...
For instance a cube that roughly describes an <<area-definition,area>> that contains 
