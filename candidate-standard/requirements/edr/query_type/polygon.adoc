...
include::../REQ_rc-coords-response.adoc[]
    ...
    <code>coords=POLYGON((x y,x1 y1,x2 y2,...,xn yn x y))</code>
    ...
    <code>coords=POLYGON((-6.1 50.3,-4.35 51.4,-2.6 51.6,-2.8 50.6,-5.3 49.9,-6.1,50.3))</code>
...
<code>`coords=POLYGON((-15 48.8,-15 60.95,5 60.85,5 48.8,-15 48.8))`</code>
...
<code>`coords=MULTIPOLYGON((-15 48.8,-15 60.95,5 60.85,5 48.8,-15 48.8),(-6.1 50.3,-4.35 51.4,-2.6 51.6,-2.8 50.6,-5.3 49.9,-6.1,50.3))`</code>
=================
...
.Return data at all a defined list of levels vertical levels
===========
...
.Return data for all levels between 2 defined levels
===========
