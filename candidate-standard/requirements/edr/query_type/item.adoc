...
e.g. return information for the requested item with an id of warning_12345 from the forecast <<collection-definition,collection>>. Returned data would include an area query end point, time range, a list of available parameters and a representative geometry for the warning_12345 warning area.
