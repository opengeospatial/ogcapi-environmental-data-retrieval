...
ogcdoc, OGC document, property, geographic information, spatial data, spatial things, spatio-temporal, dataset, distribution, API, JSON, geojson, coverageJSON, html, OpenAPI, AsyncAPI, REST, Common, position, area, trajectory, corridor, time-series, radius, polygon, wkt
