...
^|Test Method |. Validate the response document against OpenAPI 3.0 schema link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/confClasses.yaml[confClasses.yaml]
