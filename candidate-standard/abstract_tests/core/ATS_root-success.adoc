...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/landingPage.json[landingPage.json]|<<ats_html_content,/ats/html/content>>
|JSON |link:https://raw.githubusercontent.com/opengeospatial/oapi_common/master/standard/openapi/schemas/landingPage.json[landingPage.json] |<<ats_geojson_content,/ats/geojson/content>>
|===
