...
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/conf/core/rc-items*
...
* Parameter <<ats_core_bbox-definition,/conf/core/rc-bbox-definition>>
* Response <<ats_core_rc-bbox-response,/conf/core/rc-bbox-response>>

*DateTime:*

* Parameter <<ats_collections_rc-time-definition,/conf/core/rc-time-definition>>
* Response <<ats_core_rc-time-response,/conf/core/rc-time-response>>
