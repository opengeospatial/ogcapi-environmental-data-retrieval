...
* Parameter <<ats_core_rc-bbox-definition,/conf/core/rc-bbox-definition>>
* Response <<ats_core_rc-bbox-response,/conf/core/rc-bbox-response>>

*DateTime:*

* Parameter <<ats_time-definition,/conf/core/rc-time-definition>>
* Response <<ats_time-response,/conf/core/rc-time-response>>
