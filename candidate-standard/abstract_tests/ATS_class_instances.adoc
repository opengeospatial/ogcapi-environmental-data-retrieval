...
|===
2+|*Conformance Class*
2+|http://www.opengis.net/spec/ogcapi-edr-1/1.0/conf/instances
|Target type |Web API
|Requirements Class |<<rc_collections,http://www.opengis.net/spec/ogcapi-edr-1/1.0/conf/instances>>
