...
^|Requirement |<<req_collections_rc-parameter-name-response,/req/edr/parameter-name-response>>
^|Test Method |. Verify that only resources for the requested parameters were included in the result set
. Validate that the parameter-name parameter complies with the syntax described in <<req_collections_rc-parameter-name-response,/req/edr/parameter-name-response>>.
|===
