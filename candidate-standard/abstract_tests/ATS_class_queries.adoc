...
// should these point to instances/ATS_rc-md... files?
include::instances/ATS_rc-op.adoc[]

include::instances/ATS_rc-response.adoc[]

===== Instance {root}/collections/{collectionId}/instances/instanceId

include::instance/ATS_src-op.adoc[]

include::instance/ATS_src-response.adoc[]
