...
^|Requirement |<<req_edr_rc-corridor,/req/edr/rc-corridor>>
^|Test Method |. Specify a width-units value  that is not listed in the collection reposnse
. Validate that a document was returned with a status code 400.
...
^|Requirement |<<req_edr_rc-corridor,/req/edr/rc-corridor>>
^|Test Method |. Specify a height-units value  that is not listed in the collection reposnse
. Validate that a document was returned with a status code 400.
