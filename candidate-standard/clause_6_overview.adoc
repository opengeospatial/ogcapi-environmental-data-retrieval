...
|<<collectionInfo,{root}/collections/{collectionId}/instances>>| |Retrieve metadata about instances of a <<collection-definition,collection>>
|<<collectionInfo,{root}/collections/{collectionId}/instances/{instanceId}>>| |Retrieve metadata from a specific instance of a <<collection-definition,collection>> which has the unique identifier `{instanceId}`
|===
...
* `{instanceId}` = an identifier for a specific version or instance of a <<collection-definition,collection>> of data
