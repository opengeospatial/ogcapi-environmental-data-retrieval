...
The OGC API-Common-Part 1: Core requirements class is specified in *Requirements Class Core* <<rc_core-section,(Chapter 8)>>.
...
* <<query-resources-section,Queries>>, nine Requirements classes
...
At least one of the 9 queries shall be implemented.
