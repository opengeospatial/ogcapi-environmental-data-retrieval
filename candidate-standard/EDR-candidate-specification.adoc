:Title: EDR Candidate Specification API
:titletext: OGC API - Environmental Data Retrieval Standard
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
= EDR Candidate Specification API
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/
|Internal reference number of this OGC(R) document:    19-086
|Version: 0.0.3
