...
|Internal reference number of this OGC(R) document:    19-086r4
|Version: 1.0.1-SNAPSHOT (Editor’s draft)
...
include::clause_8_queries.adoc[]

include::clause_9_general.adoc[]

include::annex_requirements.adoc[]

include::annex_ats.adoc[]

include::annex_collection_response.adoc[]

include::annex_examples.adoc[]

include::annex_relationship.adoc[]
