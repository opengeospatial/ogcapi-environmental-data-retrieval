:Title: OGC API - Environmental Data Retrieval: response to public comments
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document:
|Internal reference number of this OGC(R) document:
|Version:
|Category: OGC(R)  Response to Comments
|Editor: Chris Little
|===
...
[width = "50%", grid = "none"]
|===
|Document type:   	OGC® Response to Comments
|Document subtype:   
|Document stage:   
...
This OGC Response to Comments document provides detailed responses to each of the comments received during the Public Comment period.

[big]*ii.    Keywords*

The following are keywords to be used by search engines and document catalogues.

ogcdoc, OGC document, comments

[big]*iii.   Preface*

The Request for Public Comment ended on 2020-09-28. Four comments were received. These comments generally concerned the relationship between the OGC API - Environmental Data Retrieval candidate Standard and existing OGC Standards and other means for using coverage and observation data. Specific comments are addressed below.
