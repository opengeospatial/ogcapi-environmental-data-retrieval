:Title: OGC API - Environmental Data Retrieval Best Practice.
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/bp/ogcapi-edrBP/1.0
|Internal reference number of this OGC(R) document:    20-065
|Version: 0.1
|Category: OGC(R) Best Practice
|Editor:   Chris Little, Mark Burgoyne, etc
|===
